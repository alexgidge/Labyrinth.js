...
$(function () {
    ...
    $('#btnSaveGraphics').click(function (evt) {
        SaveGraphicsSettingsForm(evt);
    });
});

async function PopulateGraphicsSettingsForm() {
...
async function SaveGraphicsSettingsForm(evt) {
...
const GraphicsSettingsTemplate = ({ }) => `
<div>
