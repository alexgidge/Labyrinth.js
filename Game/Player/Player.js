class Player extends Character {
    ...
    OnEnemyCollide(targetLocation, characterAtTarget) {
        EngineAudio.PlaySound(this.World, this.Type, this.bounceOffWallSound, false, targetLocation.x, targetLocation.y);//TODO: Change to different bounce sound. bump 
    }
    ...
    OnSpawn(location) {
        EngineAudio.PlaySound(this.World, this.Type, this.breathe, false, location.x, location.y);//TODO: Check X,Y & Z. 
        EngineAudio.PlaySound(this.World, this.Type, this.drawWeapon, false, location.x, location.y - 1, - 1);
    }
}