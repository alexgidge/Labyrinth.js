class Game {
    ...
    GameOver(gameState) {
        ...
        if (gameState == GameStateType.Dead.Value) {
            restartTime = 4000;
            Engine.Current.EngineAudio.PlaySound(this.World, "AMBIENT", "GAME", 'GAMELOSE', false, player.Transform.Position.x, player.Transform.Position.y);
            ...
            restartTime = 30000;
            Engine.Current.EngineAudio.PlaySound(this.World, "AMBIENT", "GAME", 'GAMEWIN', false, player.Transform.Position.x, player.Transform.Position.y);
